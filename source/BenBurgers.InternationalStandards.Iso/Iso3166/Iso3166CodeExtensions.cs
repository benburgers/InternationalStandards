...
public static class Iso3166CodeExtensions
{
    ...
    private static readonly IReadOnlyDictionary<string, Iso3166Code> AlphaLookup =
        Attributes
            .SelectMany(kvp => new[] { new KeyValuePair<string, Iso3166Code>(kvp.Value.Alpha2, kvp.Key), new KeyValuePair<string, Iso3166Code>(kvp.Value.Alpha3, kvp.Key) })
    ...
    {
        return Attributes[iso3166Code].Alpha2;
    }
    ...
    {
        return Attributes[iso3166Code].Alpha3;
    }
