...
internal sealed class Iso4217SqlServerEntityConfiguration : IEntityTypeConfiguration<Iso4217Entity>
{
    private readonly string schemaName;

    /// <summary>
    /// Initializes a new instance of <see cref="Iso4217SqlServerEntityConfiguration" />.
    /// </summary>
    /// <param name="schemaName">
    /// The name of the SQL Server Schema for ISO tables.
    /// </param>
    internal Iso4217SqlServerEntityConfiguration(string schemaName)
    {
