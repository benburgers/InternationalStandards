...
/// </summary>
public sealed class Iso4217CodeMinorUnitsNullableComparer : IComparer<Iso4217Code?>
{
    /// <inheritdoc />
    public int Compare(Iso4217Code? x, Iso4217Code? y) =>
        (x, y) switch
        {
            ...
            (null, _) => int.MinValue,
            (_, null) => int.MaxValue,
            ({ } x1, { } y1) => x1.ToModel().CurrencyMinorUnits?.CompareTo(y1.ToModel().CurrencyMinorUnits) ?? int.MinValue
        };
}
