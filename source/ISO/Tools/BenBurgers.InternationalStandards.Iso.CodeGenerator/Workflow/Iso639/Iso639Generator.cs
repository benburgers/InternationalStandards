    ...
    private static CodeCommentStatementCollection EnumDocumentation(DateTimeOffset iso639EffectiveDate) =>
        new(
            new CodeCommentStatement[]
            {
                ...
                new("<remarks>", true),
                new("<para>The <a href=\"https://www.austrian-standards.at/en\">Austrian Standards</a> is the sole authority of ISO 639-1 codes.<br />Only they can designate ISO 639-1 codes. This work is a derivation and enhancement and anything other than ISO 639-1 is the responsibility of the respective copyright holders.</para>", true),
